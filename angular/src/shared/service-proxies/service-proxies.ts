...
export class TenantSettingsServiceProxy {
    ...
    getAll(): Observable<SettingDto[]> {
        let url_ = this.baseUrl + "/api/services/app/TenantSettings/GetAll";
        url_ = url_.replace(/[?&]$/, "");
     ...
     * @return Success
     */
    change(body: SettingDto[] | null | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/TenantSettings/Change";
        url_ = url_.replace(/[?&]$/, "");
