...
class Tenant extends React.Component<ITenantProps> {
  ...
  public render() {
    ...
    const columns = [
      { title: 'Tenancy Name', dataIndex: 'tenancyName', key: 'tenancyName', width: 150, render: (text: string) => <div>{text}</div> },
      { title: 'Name', dataIndex: 'name', key: 'name', width: 150, render: (text: string) => <div>{text}</div> },
      {
        title: 'Active',
        dataIndex: 'isActive',
        key: 'isActive',
